...
{   vaciar_tabla();// Vaciandola informacion de la tabla
    ...
    private void initComponents() {
        ...
        setTitle("Arreglo de Objetos y Archivos Binarios");
        ...
        btnModificar.setBounds(239, 160, 109, 30);
        ...
        label25.setText("Nombre del Libro con el Año de Edición");

        label26.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        label26.setText("más reciente.");

        jtxtsA.setSelectionColor(new java.awt.Color(0, 102, 0));

        label27.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        label27.setText("Nombre de la Editorial que tiene el libro");

        label28.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        label28.setText(" con el Menor número de páginas.");

        jtxtsB.setSelectionColor(new java.awt.Color(0, 102, 0));

        label29.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        label29.setText("Numero de Libros que supera el costo de S/ 100");

        label30.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        label30.setText(" que sean de la clase A y sean de Gestión");

        jtxtsC.setSelectionColor(new java.awt.Color(0, 102, 0));

        label31.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        label31.setText("Nombre del Libro que tenga el mayor costo");

        label32.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        label32.setText(" y a que editorial del pertenece.");

        jtxtsD2.setSelectionColor(new java.awt.Color(0, 102, 0));
        jtxtsD2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtxtsD2ActionPerformed(evt);
            }
        });

        jtxtsD1.setSelectionColor(new java.awt.Color(0, 102, 0));
        ...
        panel4Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, panel4Layout.createSequentialGroup()
            ...
            .add(panel4Layout.createSequentialGroup()
                .add(panel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(panel4Layout.createSequentialGroup()
                        .add(10, 10, 10)
                        .add(panel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(label25, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 260, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(label26, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 150, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(label27, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 260, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(label28, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 270, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(label29, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 270, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(label30, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 270, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(label31, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 270, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                            .add(label32, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 270, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                    .add(panel4Layout.createSequentialGroup()
                        .addContainerGap()
                        .add(jtxtsD2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 250, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(panel4Layout.createSequentialGroup()
                        .addContainerGap()
                        .add(jtxtsD1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 250, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(panel4Layout.createSequentialGroup()
                        .addContainerGap()
                        .add(jtxtsC, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 250, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(panel4Layout.createSequentialGroup()
                        .addContainerGap()
                        .add(jtxtsB, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 240, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(panel4Layout.createSequentialGroup()
                        .addContainerGap()
                        .add(jtxtsA, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 240, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        panel4Layout.setVerticalGroup(
            ...
            .add(panel4Layout.createSequentialGroup()
                ...
                .add(jtxtsA, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 29, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(1, 1, 1)
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jtxtsB, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 28, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(2, 2, 2)
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jtxtsC, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 28, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .add(2, 2, 2)
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jtxtsD1, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 27, Short.MAX_VALUE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                .add(jtxtsD2, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 29, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
